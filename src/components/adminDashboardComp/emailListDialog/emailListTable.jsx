...
export const columns = [
  ...
  {
    accessorKey: "status",
    header: () => ( <p className="centerTxt">Status</p>),
    cell: ({ row }) => (
      <div className={row.getValue("status") === "whitelisted" ? "statusTxt whitelisted" : 'statusTxt blacklisted'}>{row.getValue("status")}</div>
    ),
  },
  {
    id: "actions",
